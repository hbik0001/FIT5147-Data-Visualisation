document.addEventListener("DOMContentLoaded", function (event) {
    ...
    function updateGraph(data) {
        ...
        function updateRadialTree(selComp) {
            var final_filtered = "https://media.githubusercontent.com/media/hbik0001/FIT5147-Data-Visualisation/master/data/final_filtered-year.csv";
            d3.csv(final_filtered, function (d) {
